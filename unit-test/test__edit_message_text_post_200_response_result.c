#ifndef _edit_message_text_post_200_response_result_TEST
#define _edit_message_text_post_200_response_result_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define _edit_message_text_post_200_response_result_MAIN
#endif // TEST_MAIN
...
#include "../model/_edit_message_text_post_200_response_result.h"
_edit_message_text_post_200_response_result_t* instantiate__edit_message_text_post_200_response_result(int include_optional);
...
_edit_message_text_post_200_response_result_t* instantiate__edit_message_text_post_200_response_result(int include_optional) {
  _edit_message_text_post_200_response_result_t* _edit_message_text_post_200_response_result = NULL;
  if (include_optional) {
    _edit_message_text_post_200_response_result = _edit_message_text_post_200_response_result_create(
      56,
      56,
  ...
  return _edit_message_text_post_200_response_result;
}


#ifdef _edit_message_text_post_200_response_result_MAIN

void test__edit_message_text_post_200_response_result(int include_optional) {
    _edit_message_text_post_200_response_result_t* _edit_message_text_post_200_response_result_1 = instantiate__edit_message_text_post_200_response_result(include_optional);

	cJSON* json_edit_message_text_post_200_response_result_1 = _edit_message_text_post_200_response_result_convertToJSON(_edit_message_text_post_200_response_result_1);
	printf("_edit_message_text_post_200_response_result :\n%s\n", cJSON_Print(json_edit_message_text_post_200_response_result_1));
	_edit_message_text_post_200_response_result_t* _edit_message_text_post_200_response_result_2 = _edit_message_text_post_200_response_result_parseFromJSON(json_edit_message_text_post_200_response_result_1);
	cJSON* json_edit_message_text_post_200_response_result_2 = _edit_message_text_post_200_response_result_convertToJSON(_edit_message_text_post_200_response_result_2);
	printf("repeating _edit_message_text_post_200_response_result:\n%s\n", cJSON_Print(json_edit_message_text_post_200_response_result_2));
}

int main() {
  test__edit_message_text_post_200_response_result(1);
  test__edit_message_text_post_200_response_result(0);

  printf("Hello world \n");
  return 0;
}

#endif // _edit_message_text_post_200_response_result_MAIN
#endif // _edit_message_text_post_200_response_result_TEST
