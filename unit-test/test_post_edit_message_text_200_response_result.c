#ifndef post_edit_message_text_200_response_result_TEST
#define post_edit_message_text_200_response_result_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define post_edit_message_text_200_response_result_MAIN
#endif // TEST_MAIN
...
#include "../model/post_edit_message_text_200_response_result.h"
post_edit_message_text_200_response_result_t* instantiate_post_edit_message_text_200_response_result(int include_optional);
...
post_edit_message_text_200_response_result_t* instantiate_post_edit_message_text_200_response_result(int include_optional) {
  post_edit_message_text_200_response_result_t* post_edit_message_text_200_response_result = NULL;
  if (include_optional) {
    post_edit_message_text_200_response_result = post_edit_message_text_200_response_result_create(
      56,
      56,
  ...
  return post_edit_message_text_200_response_result;
}


#ifdef post_edit_message_text_200_response_result_MAIN

void test_post_edit_message_text_200_response_result(int include_optional) {
    post_edit_message_text_200_response_result_t* post_edit_message_text_200_response_result_1 = instantiate_post_edit_message_text_200_response_result(include_optional);

	cJSON* jsonpost_edit_message_text_200_response_result_1 = post_edit_message_text_200_response_result_convertToJSON(post_edit_message_text_200_response_result_1);
	printf("post_edit_message_text_200_response_result :\n%s\n", cJSON_Print(jsonpost_edit_message_text_200_response_result_1));
	post_edit_message_text_200_response_result_t* post_edit_message_text_200_response_result_2 = post_edit_message_text_200_response_result_parseFromJSON(jsonpost_edit_message_text_200_response_result_1);
	cJSON* jsonpost_edit_message_text_200_response_result_2 = post_edit_message_text_200_response_result_convertToJSON(post_edit_message_text_200_response_result_2);
	printf("repeating post_edit_message_text_200_response_result:\n%s\n", cJSON_Print(jsonpost_edit_message_text_200_response_result_2));
}

int main() {
  test_post_edit_message_text_200_response_result(1);
  test_post_edit_message_text_200_response_result(0);

  printf("Hello world \n");
  return 0;
}

#endif // post_edit_message_text_200_response_result_MAIN
#endif // post_edit_message_text_200_response_result_TEST
