/*
 * _set_my_default_administrator_rights_post_request.h
 *
 * 
 */

#ifndef __set_my_default_administrator_rights_post_request_H_
#define __set_my_default_administrator_rights_post_request_H_
...
typedef struct _set_my_default_administrator_rights_post_request_t _set_my_default_administrator_rights_post_request_t;

#include "chat_administrator_rights.h"



typedef struct _set_my_default_administrator_rights_post_request_t {
    struct chat_administrator_rights_t *rights; //model
    int for_channels; //boolean

    int _library_owned; // Is the library responsible for freeing this object?
} _set_my_default_administrator_rights_post_request_t;
...
#endif /* __set_my_default_administrator_rights_post_request_H_ */
