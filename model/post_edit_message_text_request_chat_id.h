/*
 * post_edit_message_text_request_chat_id.h
 *
 * Required if *inline\\_message\\_id* is not specified. Unique identifier for the target chat or username of the target channel (in the format &#x60;@channelusername&#x60;)
 */

#ifndef _post_edit_message_text_request_chat_id_H_
#define _post_edit_message_text_request_chat_id_H_
...
typedef struct post_edit_message_text_request_chat_id_t post_edit_message_text_request_chat_id_t;




typedef struct post_edit_message_text_request_chat_id_t {

    int _library_owned; // Is the library responsible for freeing this object?
} post_edit_message_text_request_chat_id_t;
...
#endif /* _post_edit_message_text_request_chat_id_H_ */
