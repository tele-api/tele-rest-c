/*
 * post_edit_general_forum_topic_request.h
 *
 * 
 */

#ifndef _post_edit_general_forum_topic_request_H_
#define _post_edit_general_forum_topic_request_H_
...
typedef struct post_edit_general_forum_topic_request_t post_edit_general_forum_topic_request_t;

#include "post_restrict_chat_member_request_chat_id.h"



typedef struct post_edit_general_forum_topic_request_t {
    struct post_restrict_chat_member_request_chat_id_t *chat_id; //model
    char *name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} post_edit_general_forum_topic_request_t;
...
#endif /* _post_edit_general_forum_topic_request_H_ */
