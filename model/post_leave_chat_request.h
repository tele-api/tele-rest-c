/*
 * post_leave_chat_request.h
 *
 * 
 */

#ifndef _post_leave_chat_request_H_
#define _post_leave_chat_request_H_
...
typedef struct post_leave_chat_request_t post_leave_chat_request_t;

#include "post_leave_chat_request_chat_id.h"



typedef struct post_leave_chat_request_t {
    struct post_leave_chat_request_chat_id_t *chat_id; //model

    int _library_owned; // Is the library responsible for freeing this object?
} post_leave_chat_request_t;
...
#endif /* _post_leave_chat_request_H_ */
