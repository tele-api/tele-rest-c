/*
 * _get_game_high_scores_post_200_response.h
 *
 * 
 */

#ifndef __get_game_high_scores_post_200_response_H_
#define __get_game_high_scores_post_200_response_H_
...
typedef struct _get_game_high_scores_post_200_response_t _get_game_high_scores_post_200_response_t;

#include "game_high_score.h"



typedef struct _get_game_high_scores_post_200_response_t {
    int ok; //boolean
...
#endif /* __get_game_high_scores_post_200_response_H_ */
