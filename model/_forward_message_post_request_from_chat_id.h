/*
 * _forward_message_post_request_from_chat_id.h
 *
 * Unique identifier for the chat where the original message was sent (or channel username in the format &#x60;@channelusername&#x60;)
 */

#ifndef __forward_message_post_request_from_chat_id_H_
#define __forward_message_post_request_from_chat_id_H_
...
typedef struct _forward_message_post_request_from_chat_id_t _forward_message_post_request_from_chat_id_t;




typedef struct _forward_message_post_request_from_chat_id_t {

    int _library_owned; // Is the library responsible for freeing this object?
} _forward_message_post_request_from_chat_id_t;
...
#endif /* __forward_message_post_request_from_chat_id_H_ */
