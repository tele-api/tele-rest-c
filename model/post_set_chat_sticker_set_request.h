/*
 * post_set_chat_sticker_set_request.h
 *
 * 
 */

#ifndef _post_set_chat_sticker_set_request_H_
#define _post_set_chat_sticker_set_request_H_
...
typedef struct post_set_chat_sticker_set_request_t post_set_chat_sticker_set_request_t;

#include "post_restrict_chat_member_request_chat_id.h"



typedef struct post_set_chat_sticker_set_request_t {
    struct post_restrict_chat_member_request_chat_id_t *chat_id; //model
    char *sticker_set_name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} post_set_chat_sticker_set_request_t;
...
#endif /* _post_set_chat_sticker_set_request_H_ */
