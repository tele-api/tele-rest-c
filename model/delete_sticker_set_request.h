/*
 * delete_sticker_set_request.h
 *
 * Request parameters for deleteStickerSet
 */

#ifndef _delete_sticker_set_request_H_
#define _delete_sticker_set_request_H_
...
typedef struct delete_sticker_set_request_t delete_sticker_set_request_t;




typedef struct delete_sticker_set_request_t {
    char *name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} delete_sticker_set_request_t;
...
#endif /* _delete_sticker_set_request_H_ */
