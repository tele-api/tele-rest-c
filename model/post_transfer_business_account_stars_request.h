/*
 * post_transfer_business_account_stars_request.h
 *
 * 
 */

#ifndef _post_transfer_business_account_stars_request_H_
#define _post_transfer_business_account_stars_request_H_
...
typedef struct post_transfer_business_account_stars_request_t post_transfer_business_account_stars_request_t;




typedef struct post_transfer_business_account_stars_request_t {
    char *business_connection_id; // string
    int star_count; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} post_transfer_business_account_stars_request_t;
...
#endif /* _post_transfer_business_account_stars_request_H_ */
