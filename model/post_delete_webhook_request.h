/*
 * post_delete_webhook_request.h
 *
 * 
 */

#ifndef _post_delete_webhook_request_H_
#define _post_delete_webhook_request_H_
...
typedef struct post_delete_webhook_request_t post_delete_webhook_request_t;




typedef struct post_delete_webhook_request_t {
    int drop_pending_updates; //boolean

    int _library_owned; // Is the library responsible for freeing this object?
} post_delete_webhook_request_t;
...
#endif /* _post_delete_webhook_request_H_ */
