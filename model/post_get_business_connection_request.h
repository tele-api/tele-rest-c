/*
 * post_get_business_connection_request.h
 *
 * 
 */

#ifndef _post_get_business_connection_request_H_
#define _post_get_business_connection_request_H_
...
typedef struct post_get_business_connection_request_t post_get_business_connection_request_t;




typedef struct post_get_business_connection_request_t {
    char *business_connection_id; // string

    int _library_owned; // Is the library responsible for freeing this object?
} post_get_business_connection_request_t;
...
#endif /* _post_get_business_connection_request_H_ */
