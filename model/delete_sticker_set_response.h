/*
 * delete_sticker_set_response.h
 *
 * 
 */

#ifndef _delete_sticker_set_response_H_
#define _delete_sticker_set_response_H_
...
typedef struct delete_sticker_set_response_t delete_sticker_set_response_t;




typedef struct delete_sticker_set_response_t {
    int ok; //boolean
    int result; //boolean
...
#endif /* _delete_sticker_set_response_H_ */
