/*
 * _set_chat_description_post_request.h
 *
 * 
 */

#ifndef __set_chat_description_post_request_H_
#define __set_chat_description_post_request_H_
...
typedef struct _set_chat_description_post_request_t _set_chat_description_post_request_t;

#include "_send_message_post_request_chat_id.h"



typedef struct _set_chat_description_post_request_t {
    struct _send_message_post_request_chat_id_t *chat_id; //model
    char *description; // string

    int _library_owned; // Is the library responsible for freeing this object?
} _set_chat_description_post_request_t;
...
#endif /* __set_chat_description_post_request_H_ */
