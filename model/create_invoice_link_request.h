/*
 * create_invoice_link_request.h
 *
 * Request parameters for createInvoiceLink
 */

#ifndef _create_invoice_link_request_H_
#define _create_invoice_link_request_H_
...
typedef struct create_invoice_link_request_t create_invoice_link_request_t;

#include "labeled_price.h"



typedef struct create_invoice_link_request_t {
    char *title; // string
...
#endif /* _create_invoice_link_request_H_ */
