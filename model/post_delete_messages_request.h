/*
 * post_delete_messages_request.h
 *
 * 
 */

#ifndef _post_delete_messages_request_H_
#define _post_delete_messages_request_H_
...
typedef struct post_delete_messages_request_t post_delete_messages_request_t;

#include "post_send_message_request_chat_id.h"



typedef struct post_delete_messages_request_t {
    struct post_send_message_request_chat_id_t *chat_id; //model
    list_t *message_ids; //primitive container

    int _library_owned; // Is the library responsible for freeing this object?
} post_delete_messages_request_t;
...
#endif /* _post_delete_messages_request_H_ */
