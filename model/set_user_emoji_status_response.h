/*
 * set_user_emoji_status_response.h
 *
 * 
 */

#ifndef _set_user_emoji_status_response_H_
#define _set_user_emoji_status_response_H_
...
typedef struct set_user_emoji_status_response_t set_user_emoji_status_response_t;




typedef struct set_user_emoji_status_response_t {
    int ok; //boolean
    int result; //boolean
...
#endif /* _set_user_emoji_status_response_H_ */
