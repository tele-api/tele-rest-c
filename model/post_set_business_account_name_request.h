/*
 * post_set_business_account_name_request.h
 *
 * 
 */

#ifndef _post_set_business_account_name_request_H_
#define _post_set_business_account_name_request_H_
...
typedef struct post_set_business_account_name_request_t post_set_business_account_name_request_t;




typedef struct post_set_business_account_name_request_t {
    char *business_connection_id; // string
    char *first_name; // string
    char *last_name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} post_set_business_account_name_request_t;
...
#endif /* _post_set_business_account_name_request_H_ */
