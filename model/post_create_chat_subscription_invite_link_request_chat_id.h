/*
 * post_create_chat_subscription_invite_link_request_chat_id.h
 *
 * Unique identifier for the target channel chat or username of the target channel (in the format &#x60;@channelusername&#x60;)
 */

#ifndef _post_create_chat_subscription_invite_link_request_chat_id_H_
#define _post_create_chat_subscription_invite_link_request_chat_id_H_
...
typedef struct post_create_chat_subscription_invite_link_request_chat_id_t post_create_chat_subscription_invite_link_request_chat_id_t;




typedef struct post_create_chat_subscription_invite_link_request_chat_id_t {

    int _library_owned; // Is the library responsible for freeing this object?
} post_create_chat_subscription_invite_link_request_chat_id_t;
...
#endif /* _post_create_chat_subscription_invite_link_request_chat_id_H_ */
