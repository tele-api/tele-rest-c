/*
 * post_get_my_commands_request.h
 *
 * 
 */

#ifndef _post_get_my_commands_request_H_
#define _post_get_my_commands_request_H_
...
typedef struct post_get_my_commands_request_t post_get_my_commands_request_t;

#include "bot_command_scope.h"



typedef struct post_get_my_commands_request_t {
    struct bot_command_scope_t *scope; //model
    char *language_code; // string

    int _library_owned; // Is the library responsible for freeing this object?
} post_get_my_commands_request_t;
...
#endif /* _post_get_my_commands_request_H_ */
