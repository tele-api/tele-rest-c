/*
 * send_audio_request.h
 *
 * Request parameters for sendAudio
 */

#ifndef _send_audio_request_H_
#define _send_audio_request_H_
...
typedef struct send_audio_request_t send_audio_request_t;
...
typedef struct send_audio_request_t {
