/*
 * _edit_chat_subscription_invite_link_post_request.h
 *
 * 
 */

#ifndef __edit_chat_subscription_invite_link_post_request_H_
#define __edit_chat_subscription_invite_link_post_request_H_
...
typedef struct _edit_chat_subscription_invite_link_post_request_t _edit_chat_subscription_invite_link_post_request_t;

#include "_send_message_post_request_chat_id.h"



typedef struct _edit_chat_subscription_invite_link_post_request_t {
    struct _send_message_post_request_chat_id_t *chat_id; //model
    char *invite_link; // string
    char *name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} _edit_chat_subscription_invite_link_post_request_t;
...
#endif /* __edit_chat_subscription_invite_link_post_request_H_ */
