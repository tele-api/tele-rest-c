/*
 * _get_chat_member_post_request.h
 *
 * 
 */

#ifndef __get_chat_member_post_request_H_
#define __get_chat_member_post_request_H_
...
typedef struct _get_chat_member_post_request_t _get_chat_member_post_request_t;

#include "_leave_chat_post_request_chat_id.h"



typedef struct _get_chat_member_post_request_t {
    struct _leave_chat_post_request_chat_id_t *chat_id; //model
    int user_id; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} _get_chat_member_post_request_t;
...
#endif /* __get_chat_member_post_request_H_ */
