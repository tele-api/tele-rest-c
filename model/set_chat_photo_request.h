/*
 * set_chat_photo_request.h
 *
 * Request parameters for setChatPhoto
 */

#ifndef _set_chat_photo_request_H_
#define _set_chat_photo_request_H_
...
typedef struct set_chat_photo_request_t set_chat_photo_request_t;
...
typedef struct set_chat_photo_request_t {
    struct send_message_request_chat_id_t *chat_id; //model
    any_type_t *photo; // custom

    int _library_owned; // Is the library responsible for freeing this object?
} set_chat_photo_request_t;
...
#endif /* _set_chat_photo_request_H_ */
