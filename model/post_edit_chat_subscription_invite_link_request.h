/*
 * post_edit_chat_subscription_invite_link_request.h
 *
 * 
 */

#ifndef _post_edit_chat_subscription_invite_link_request_H_
#define _post_edit_chat_subscription_invite_link_request_H_
...
typedef struct post_edit_chat_subscription_invite_link_request_t post_edit_chat_subscription_invite_link_request_t;

#include "post_send_message_request_chat_id.h"



typedef struct post_edit_chat_subscription_invite_link_request_t {
    struct post_send_message_request_chat_id_t *chat_id; //model
    char *invite_link; // string
    char *name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} post_edit_chat_subscription_invite_link_request_t;
...
#endif /* _post_edit_chat_subscription_invite_link_request_H_ */
