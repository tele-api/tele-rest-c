/*
 * set_webhook_response.h
 *
 * 
 */

#ifndef _set_webhook_response_H_
#define _set_webhook_response_H_
...
typedef struct set_webhook_response_t set_webhook_response_t;




typedef struct set_webhook_response_t {
    int ok; //boolean
    int result; //boolean
...
#endif /* _set_webhook_response_H_ */
