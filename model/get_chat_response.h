...
#ifndef _get_chat_response_H_
#define _get_chat_response_H_
...
typedef struct get_chat_response_t get_chat_response_t;

#include "chat_full_info.h"



typedef struct get_chat_response_t {
    int ok; //boolean
