/*
 * post_delete_sticker_from_set_request.h
 *
 * 
 */

#ifndef _post_delete_sticker_from_set_request_H_
#define _post_delete_sticker_from_set_request_H_
...
typedef struct post_delete_sticker_from_set_request_t post_delete_sticker_from_set_request_t;




typedef struct post_delete_sticker_from_set_request_t {
    char *sticker; // string

    int _library_owned; // Is the library responsible for freeing this object?
} post_delete_sticker_from_set_request_t;
...
#endif /* _post_delete_sticker_from_set_request_H_ */
