/*
 * _delete_sticker_from_set_post_request.h
 *
 * 
 */

#ifndef __delete_sticker_from_set_post_request_H_
#define __delete_sticker_from_set_post_request_H_
...
typedef struct _delete_sticker_from_set_post_request_t _delete_sticker_from_set_post_request_t;




typedef struct _delete_sticker_from_set_post_request_t {
    char *sticker; // string
...
#endif /* __delete_sticker_from_set_post_request_H_ */
