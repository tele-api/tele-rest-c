/*
 * set_my_description_request.h
 *
 * Request parameters for setMyDescription
 */

#ifndef _set_my_description_request_H_
#define _set_my_description_request_H_
...
typedef struct set_my_description_request_t set_my_description_request_t;




typedef struct set_my_description_request_t {
    char *description; // string
    char *language_code; // string

    int _library_owned; // Is the library responsible for freeing this object?
} set_my_description_request_t;
...
#endif /* _set_my_description_request_H_ */
