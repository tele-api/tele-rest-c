/*
 * send_video_request.h
 *
 * Request parameters for sendVideo
 */

#ifndef _send_video_request_H_
#define _send_video_request_H_
...
typedef struct send_video_request_t send_video_request_t;
...
typedef struct send_video_request_t {
