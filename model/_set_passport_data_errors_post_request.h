/*
 * _set_passport_data_errors_post_request.h
 *
 * 
 */

#ifndef __set_passport_data_errors_post_request_H_
#define __set_passport_data_errors_post_request_H_
...
typedef struct _set_passport_data_errors_post_request_t _set_passport_data_errors_post_request_t;

#include "passport_element_error.h"



typedef struct _set_passport_data_errors_post_request_t {
    int user_id; //numeric
    list_t *errors; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} _set_passport_data_errors_post_request_t;
...
#endif /* __set_passport_data_errors_post_request_H_ */
