/*
 * _get_custom_emoji_stickers_post_request.h
 *
 * 
 */

#ifndef __get_custom_emoji_stickers_post_request_H_
#define __get_custom_emoji_stickers_post_request_H_
...
typedef struct _get_custom_emoji_stickers_post_request_t _get_custom_emoji_stickers_post_request_t;




typedef struct _get_custom_emoji_stickers_post_request_t {
    list_t *custom_emoji_ids; //primitive container

    int _library_owned; // Is the library responsible for freeing this object?
} _get_custom_emoji_stickers_post_request_t;
...
#endif /* __get_custom_emoji_stickers_post_request_H_ */
