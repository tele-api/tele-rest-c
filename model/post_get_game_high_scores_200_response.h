/*
 * post_get_game_high_scores_200_response.h
 *
 * 
 */

#ifndef _post_get_game_high_scores_200_response_H_
#define _post_get_game_high_scores_200_response_H_
...
typedef struct post_get_game_high_scores_200_response_t post_get_game_high_scores_200_response_t;

#include "game_high_score.h"



typedef struct post_get_game_high_scores_200_response_t {
    int ok; //boolean
...
#endif /* _post_get_game_high_scores_200_response_H_ */
