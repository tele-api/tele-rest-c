/*
 * _get_chat_member_count_post_200_response.h
 *
 * 
 */

#ifndef __get_chat_member_count_post_200_response_H_
#define __get_chat_member_count_post_200_response_H_
...
typedef struct _get_chat_member_count_post_200_response_t _get_chat_member_count_post_200_response_t;




typedef struct _get_chat_member_count_post_200_response_t {
    int ok; //boolean
    int result; //numeric
...
#endif /* __get_chat_member_count_post_200_response_H_ */
