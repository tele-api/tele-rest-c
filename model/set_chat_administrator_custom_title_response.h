/*
 * set_chat_administrator_custom_title_response.h
 *
 * 
 */

#ifndef _set_chat_administrator_custom_title_response_H_
#define _set_chat_administrator_custom_title_response_H_
...
typedef struct set_chat_administrator_custom_title_response_t set_chat_administrator_custom_title_response_t;




typedef struct set_chat_administrator_custom_title_response_t {
    int ok; //boolean
    int result; //boolean
...
#endif /* _set_chat_administrator_custom_title_response_H_ */
