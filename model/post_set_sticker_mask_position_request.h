/*
 * post_set_sticker_mask_position_request.h
 *
 * 
 */

#ifndef _post_set_sticker_mask_position_request_H_
#define _post_set_sticker_mask_position_request_H_
...
typedef struct post_set_sticker_mask_position_request_t post_set_sticker_mask_position_request_t;

#include "mask_position.h"



typedef struct post_set_sticker_mask_position_request_t {
    char *sticker; // string
    struct mask_position_t *mask_position; //model

    int _library_owned; // Is the library responsible for freeing this object?
} post_set_sticker_mask_position_request_t;
...
#endif /* _post_set_sticker_mask_position_request_H_ */
