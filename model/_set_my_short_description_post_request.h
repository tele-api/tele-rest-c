/*
 * _set_my_short_description_post_request.h
 *
 * 
 */

#ifndef __set_my_short_description_post_request_H_
#define __set_my_short_description_post_request_H_
...
typedef struct _set_my_short_description_post_request_t _set_my_short_description_post_request_t;




typedef struct _set_my_short_description_post_request_t {
    char *short_description; // string
    char *language_code; // string

    int _library_owned; // Is the library responsible for freeing this object?
} _set_my_short_description_post_request_t;
...
#endif /* __set_my_short_description_post_request_H_ */
