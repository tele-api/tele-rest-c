/*
 * post_set_business_account_gift_settings_request.h
 *
 * 
 */

#ifndef _post_set_business_account_gift_settings_request_H_
#define _post_set_business_account_gift_settings_request_H_
...
typedef struct post_set_business_account_gift_settings_request_t post_set_business_account_gift_settings_request_t;

#include "accepted_gift_types.h"



typedef struct post_set_business_account_gift_settings_request_t {
    char *business_connection_id; // string
    int show_gift_button; //boolean
    struct accepted_gift_types_t *accepted_gift_types; //model

    int _library_owned; // Is the library responsible for freeing this object?
} post_set_business_account_gift_settings_request_t;
...
#endif /* _post_set_business_account_gift_settings_request_H_ */
