...
void bot_command_scope_free(bot_command_scope_t *bot_command_scope) {
    ...
    if (bot_command_scope->chat_id) {
        post_restrict_chat_member_request_chat_id_free(bot_command_scope->chat_id);
...
cJSON *bot_command_scope_convertToJSON(bot_command_scope_t *bot_command_scope) {
    ...
    cJSON *chat_id_local_JSON = post_restrict_chat_member_request_chat_id_convertToJSON(bot_command_scope->chat_id);
