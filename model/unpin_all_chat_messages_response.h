/*
 * unpin_all_chat_messages_response.h
 *
 * 
 */

#ifndef _unpin_all_chat_messages_response_H_
#define _unpin_all_chat_messages_response_H_
...
typedef struct unpin_all_chat_messages_response_t unpin_all_chat_messages_response_t;




typedef struct unpin_all_chat_messages_response_t {
    int ok; //boolean
    int result; //boolean
...
#endif /* _unpin_all_chat_messages_response_H_ */
