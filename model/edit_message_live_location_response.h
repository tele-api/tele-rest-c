/*
 * edit_message_live_location_response.h
 *
 * 
 */

#ifndef _edit_message_live_location_response_H_
#define _edit_message_live_location_response_H_
...
typedef struct edit_message_live_location_response_t edit_message_live_location_response_t;

#include "edit_message_text_response_result.h"



typedef struct edit_message_live_location_response_t {
    int ok; //boolean
...
#endif /* _edit_message_live_location_response_H_ */
