/*
 * send_photo_request.h
 *
 * Request parameters for sendPhoto
 */

#ifndef _send_photo_request_H_
#define _send_photo_request_H_
...
typedef struct send_photo_request_t send_photo_request_t;
...
typedef struct send_photo_request_t {
