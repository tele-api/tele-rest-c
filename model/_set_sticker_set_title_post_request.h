/*
 * _set_sticker_set_title_post_request.h
 *
 * 
 */

#ifndef __set_sticker_set_title_post_request_H_
#define __set_sticker_set_title_post_request_H_
...
typedef struct _set_sticker_set_title_post_request_t _set_sticker_set_title_post_request_t;




typedef struct _set_sticker_set_title_post_request_t {
    char *name; // string
    char *title; // string

    int _library_owned; // Is the library responsible for freeing this object?
} _set_sticker_set_title_post_request_t;
...
#endif /* __set_sticker_set_title_post_request_H_ */
