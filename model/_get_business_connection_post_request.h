/*
 * _get_business_connection_post_request.h
 *
 * 
 */

#ifndef __get_business_connection_post_request_H_
#define __get_business_connection_post_request_H_
...
typedef struct _get_business_connection_post_request_t _get_business_connection_post_request_t;




typedef struct _get_business_connection_post_request_t {
    char *business_connection_id; // string

    int _library_owned; // Is the library responsible for freeing this object?
} _get_business_connection_post_request_t;
...
#endif /* __get_business_connection_post_request_H_ */
