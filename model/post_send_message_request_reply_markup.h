/*
 * post_send_message_request_reply_markup.h
 *
 * Additional interface options. A JSON-serialized object for an [inline keyboard](https://core.telegram.org/bots/features#inline-keyboards), [custom reply keyboard](https://core.telegram.org/bots/features#keyboards), instructions to remove a reply keyboard or to force a reply from the user
 */

#ifndef _post_send_message_request_reply_markup_H_
#define _post_send_message_request_reply_markup_H_
...
typedef struct post_send_message_request_reply_markup_t post_send_message_request_reply_markup_t;
...
typedef struct post_send_message_request_reply_markup_t {
...
} post_send_message_request_reply_markup_t;
...
#endif /* _post_send_message_request_reply_markup_H_ */
