/*
 * post_get_chat_member_count_200_response.h
 *
 * 
 */

#ifndef _post_get_chat_member_count_200_response_H_
#define _post_get_chat_member_count_200_response_H_
...
typedef struct post_get_chat_member_count_200_response_t post_get_chat_member_count_200_response_t;




typedef struct post_get_chat_member_count_200_response_t {
    int ok; //boolean
    int result; //numeric
...
#endif /* _post_get_chat_member_count_200_response_H_ */
