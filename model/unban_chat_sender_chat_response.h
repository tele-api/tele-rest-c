/*
 * unban_chat_sender_chat_response.h
 *
 * 
 */

#ifndef _unban_chat_sender_chat_response_H_
#define _unban_chat_sender_chat_response_H_
...
typedef struct unban_chat_sender_chat_response_t unban_chat_sender_chat_response_t;




typedef struct unban_chat_sender_chat_response_t {
    int ok; //boolean
    int result; //boolean
...
#endif /* _unban_chat_sender_chat_response_H_ */
