/*
 * post_set_sticker_keywords_request.h
 *
 * 
 */

#ifndef _post_set_sticker_keywords_request_H_
#define _post_set_sticker_keywords_request_H_
...
typedef struct post_set_sticker_keywords_request_t post_set_sticker_keywords_request_t;




typedef struct post_set_sticker_keywords_request_t {
    char *sticker; // string
    list_t *keywords; //primitive container

    int _library_owned; // Is the library responsible for freeing this object?
} post_set_sticker_keywords_request_t;
...
#endif /* _post_set_sticker_keywords_request_H_ */
