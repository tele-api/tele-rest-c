/*
 * set_business_account_name_request.h
 *
 * Request parameters for setBusinessAccountName
 */

#ifndef _set_business_account_name_request_H_
#define _set_business_account_name_request_H_
...
typedef struct set_business_account_name_request_t set_business_account_name_request_t;




typedef struct set_business_account_name_request_t {
    char *business_connection_id; // string
    char *first_name; // string
    char *last_name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} set_business_account_name_request_t;
...
#endif /* _set_business_account_name_request_H_ */
