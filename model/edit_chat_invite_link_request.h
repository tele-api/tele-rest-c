/*
 * edit_chat_invite_link_request.h
 *
 * Request parameters for editChatInviteLink
 */

#ifndef _edit_chat_invite_link_request_H_
#define _edit_chat_invite_link_request_H_
...
typedef struct edit_chat_invite_link_request_t edit_chat_invite_link_request_t;

#include "send_message_request_chat_id.h"



typedef struct edit_chat_invite_link_request_t {
...
} edit_chat_invite_link_request_t;
...
#endif /* _edit_chat_invite_link_request_H_ */
