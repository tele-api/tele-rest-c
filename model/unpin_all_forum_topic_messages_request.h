/*
 * unpin_all_forum_topic_messages_request.h
 *
 * Request parameters for unpinAllForumTopicMessages
 */

#ifndef _unpin_all_forum_topic_messages_request_H_
#define _unpin_all_forum_topic_messages_request_H_
...
typedef struct unpin_all_forum_topic_messages_request_t unpin_all_forum_topic_messages_request_t;

#include "bot_command_scope_chat_chat_id.h"



typedef struct unpin_all_forum_topic_messages_request_t {
    struct bot_command_scope_chat_chat_id_t *chat_id; //model
    int message_thread_id; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} unpin_all_forum_topic_messages_request_t;
...
#endif /* _unpin_all_forum_topic_messages_request_H_ */
