/*
 * _set_user_emoji_status_post_request.h
 *
 * 
 */

#ifndef __set_user_emoji_status_post_request_H_
#define __set_user_emoji_status_post_request_H_
...
typedef struct _set_user_emoji_status_post_request_t _set_user_emoji_status_post_request_t;




typedef struct _set_user_emoji_status_post_request_t {
    int user_id; //numeric
    char *emoji_status_custom_emoji_id; // string
    int emoji_status_expiration_date; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} _set_user_emoji_status_post_request_t;
...
#endif /* __set_user_emoji_status_post_request_H_ */
