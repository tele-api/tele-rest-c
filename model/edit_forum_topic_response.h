/*
 * edit_forum_topic_response.h
 *
 * 
 */

#ifndef _edit_forum_topic_response_H_
#define _edit_forum_topic_response_H_
...
typedef struct edit_forum_topic_response_t edit_forum_topic_response_t;




typedef struct edit_forum_topic_response_t {
    int ok; //boolean
    int result; //boolean
...
#endif /* _edit_forum_topic_response_H_ */
