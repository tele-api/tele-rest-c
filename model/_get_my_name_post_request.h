/*
 * _get_my_name_post_request.h
 *
 * 
 */

#ifndef __get_my_name_post_request_H_
#define __get_my_name_post_request_H_
...
typedef struct _get_my_name_post_request_t _get_my_name_post_request_t;




typedef struct _get_my_name_post_request_t {
    char *language_code; // string

    int _library_owned; // Is the library responsible for freeing this object?
} _get_my_name_post_request_t;
...
#endif /* __get_my_name_post_request_H_ */
