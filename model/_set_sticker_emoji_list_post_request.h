/*
 * _set_sticker_emoji_list_post_request.h
 *
 * 
 */

#ifndef __set_sticker_emoji_list_post_request_H_
#define __set_sticker_emoji_list_post_request_H_
...
typedef struct _set_sticker_emoji_list_post_request_t _set_sticker_emoji_list_post_request_t;




typedef struct _set_sticker_emoji_list_post_request_t {
    char *sticker; // string
    list_t *emoji_list; //primitive container

    int _library_owned; // Is the library responsible for freeing this object?
} _set_sticker_emoji_list_post_request_t;
...
#endif /* __set_sticker_emoji_list_post_request_H_ */
