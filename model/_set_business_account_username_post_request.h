/*
 * _set_business_account_username_post_request.h
 *
 * 
 */

#ifndef __set_business_account_username_post_request_H_
#define __set_business_account_username_post_request_H_
...
typedef struct _set_business_account_username_post_request_t _set_business_account_username_post_request_t;




typedef struct _set_business_account_username_post_request_t {
    char *business_connection_id; // string
    char *username; // string

    int _library_owned; // Is the library responsible for freeing this object?
} _set_business_account_username_post_request_t;
...
#endif /* __set_business_account_username_post_request_H_ */
